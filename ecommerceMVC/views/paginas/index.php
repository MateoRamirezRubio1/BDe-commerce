<main>
    <aside>
        <div>
            ...
            <form action="/BDe-commerce/ecommerceMVC/public/index.php" method="GET">
        ...
        <div>
            ...
            <nav>
                <?php foreach ($categorias as $categoria) : ?>
                    <a href="/BDe-commerce/ecommerceMVC/public/index.php/?nombre=<?php echo $categoria->name ?>&categoria=<?php echo $categoria->id ?>"><?php echo $categoria->name; ?></a>
                <?php endforeach; ?>
            </nav>
        </div>
    </aside>
    ...
    <section>
        ...
        <?php foreach ($productosCategoria as $producto) :
            ...
            echo "<br>";
        ?>
            <a href="/BDe-commerce/ecommerceMVC/public/index.php/producto?producto=<?php echo $producto->id; ?>">Ver Producto</a>
